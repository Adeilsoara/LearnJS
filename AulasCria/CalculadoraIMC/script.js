function imc() {
    ...
    if (calculoIMC < 18.5) {
        document.getElementById('resultado').innerText = `O seu IMC é de: ${calculoIMC} e sua faixa é: Magreza`
    } else if(calculoIMC >= 18.5 && calculoIMC < 24.9){
        document.getElementById('resultado').innerText = `O seu IMC é de: ${calculoIMC} e sua faixa é: Saudável`
